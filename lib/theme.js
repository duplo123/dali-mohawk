...
//   - If theme.voicePreset is set, look it up in VOICE_PRESETS.
//   - Otherwise fall back to env vars (the original Mohawk wiring).
// Returns { voiceId, voiceSettings } or throws if nothing is configured.
